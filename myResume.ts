// Portfolio Data - Centralized data store for Amruta Bendale's portfolio
...
const portfolioData = {
    ...
    projects: [
        {
            ...
            description: "AI-powered data analysis assistant with natural language querying and automated analytics outputs",
    ...
    certifications: [
        { name: "Anthropic Claude with Amazon Bedrock (Anthropic)", url: null }
    ],
